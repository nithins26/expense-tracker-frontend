import { a0 as commonjsGlobal, P as getDefaultExportFromCjs, r as reactExports, T as React, U as jsxRuntimeExports } from "./worker-entry-Cxirg5m8.js";
import { e as expenseService } from "./expenseService-Bh83fEw4.js";
import { C as Card, a as CardHeader, b as CardTitle, d as CardContent, L as Label$1, c as CardDescription } from "./label-CE-f0aKx.js";
import { I as Input } from "./input-D2niD7v4.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-DQOM0HV5.js";
import { S as Search, B as Badge, T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./badge-Blm8Kwhr.js";
import { a as clsx } from "./index-TyoOKPst.js";
import "node:events";
import "node:async_hooks";
import "node:stream/web";
import "node:stream";
import "./router-Q8VAmIuZ.js";
import "./index-BfU5L8LY.js";
import "./index-DQ5tVeXq.js";
...
function ReportPage() {
  ...
  const EXPENSE_CATEGORIES = reactExports.useMemo(() => Array.from(new Set(expenses.map((expense) => expense.category).filter(Boolean))), [expenses]);
  ...
  const filtered = reactExports.useMemo(() => {
    return expenses.filter((e) => {
      ...
      if (search && !(e.notes || "").toLowerCase().includes(search.toLowerCase()) && !e.category.toLowerCase().includes(search.toLowerCase())) return false;
      return true;
    });
  ...
  const grouped = reactExports.useMemo(() => {
    ...
    for (const e of filtered) {
      const k2 = e.date.slice(0, 7);
      const arr = map2.get(k2) ?? [];
      arr.push(e);
      map2.set(k2, arr);
    }
    return Array.from(map2.entries()).sort((a2, b) => b[0].localeCompare(a2[0]));
  }, [filtered]);
  const categoryTotals = reactExports.useMemo(() => {
    const totals = {};
    for (const c2 of EXPENSE_CATEGORIES) totals[c2] = 0;
    for (const e of filtered) totals[e.category] = (totals[e.category] || 0) + e.amount;
    return EXPENSE_CATEGORIES.map((c2, i) => ({
      category: c2,
      total: totals[c2],
      fill: `var(--color-chart-${i % 6 + 1})`
    }));
  }, [filtered]);
  const grandTotal = filtered.reduce((s2, e) => s2 + e.amount, 0);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold tracking-tight", children: "Monthly report" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Analyze your spending across categories" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: category, onValueChange: (v) => setCategory(v), children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
              ...
              EXPENSE_CATEGORIES.map((c2) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: c2, children: c2 }, c2))
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { children: "From" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "date", value: from, onChange: (e) => setFrom(e.target.value) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { children: "To" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "date", value: to, onChange: (e) => setTo(e.target.value) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { children: "Search" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { className: "pl-8", value: search, onChange: (e) => setSearch(e.target.value), placeholder: "Notes or category" })
          ] })
        ] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 lg:grid-cols-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "lg:col-span-3", style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Spend by category" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardDescription, { children: [
            "Total: ",
            formatCurrency(grandTotal)
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-72 w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: categoryTotals, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "total", radius: [6, 6, 0, 0] })
        ] }) }) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "lg:col-span-2", style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "By category" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Breakdown across the filtered range" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: categoryTotals.map((c2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center justify-between text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-3 w-3 rounded-sm", style: {
              background: c2.fill
            } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: c2.category })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono font-medium", children: formatCurrency(c2.total) })
        ] }, c2.category)) }) })
      ] })
    ] }),
    grouped.map(([month, items]) => {
      const mTotal = items.reduce((s2, e) => s2 + e.amount, 0);
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "flex-row items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: (/* @__PURE__ */ new Date(month + "-01")).toLocaleDateString("en-US", {
              month: "long",
              year: "numeric"
            }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardDescription, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "font-mono", children: formatCurrency(mTotal) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: items.map((e) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-sm", children: new Date(e.date).toLocaleDateString() }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", children: e.category }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-sm text-muted-foreground", children: e.notes || "—" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right font-mono", children: formatCurrency(e.amount) })
          ] }, e.id)) })
        ] }) })
      ] }, month);
    }),
    grouped.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { style: {
      boxShadow: "var(--shadow-card)"
    }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "py-12 text-center text-sm text-muted-foreground", children: "No expenses match these filters." }) })
  ] });
}
export {
