      ...
      const parse = ({ pathname, search, hash, href, state: state2 }) => {
        if (!this.rewrite && !/[ \x00-\x1f\x7f\u0080-\uffff]/.test(pathname)) {
          ...
          return {
            ...
            state: replaceEqualDeep(previousLocation?.state, state2)
          };
        }
...
const appCss = "/assets/styles-DtQqCuHp.css";
...
const Route$8 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Track expenses, lending, and monthly budgets in one clean dashboard." },
      { name: "author", content: "Personal Expense Tracker" },
      { property: "og:title", content: "Personal Expense Tracker" },
      { property: "og:description", content: "Track expenses, lending, and monthly budgets in one clean dashboard." },
...
const useTheme = () => {
  ...
  const setTheme = (theme2) => {
    if (!isBrowser) return;
    localStorage.setItem("pet:theme", theme2);
    applyTheme(theme2);
    emitTheme();
  };
  return {
...
const $$splitComponentImporter$7 = () => import("./signup-Dg0pcwXP.js");
...
const $$splitComponentImporter$6 = () => import("./login-QB_k8taN.js");
...
const $$splitComponentImporter$5 = () => import("./_app-BpD7gtSS.js");
...
const $$splitComponentImporter$4 = () => import("./index-aUWnFPA8.js");
const Route$4 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./_app.report-B9iSLhQS.js");
const Route$3 = createFileRoute("/_app/report")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./_app.lending-B4LW9ahm.js");
const Route$2 = createFileRoute("/_app/lending")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./_app.expenses-rcLmWOzB.js");
const Route$1 = createFileRoute("/_app/expenses")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./_app.dashboard-CIISP5dy.js");
...
const AppReportRoute = Route$3.update({
  id: "/report",
  path: "/report",
  getParentRoute: () => AppRoute
});
const AppLendingRoute = Route$2.update({
  id: "/lending",
  path: "/lending",
  getParentRoute: () => AppRoute
});
const AppExpensesRoute = Route$1.update({
  id: "/expenses",
  path: "/expenses",
  getParentRoute: () => AppRoute
});
